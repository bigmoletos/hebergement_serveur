            ...
            script('''
                pipeline {
                    ...
                    environment {
                        ...
                        API_SUBDOMAIN = 'api'
                        IHM_SUBDOMAIN = "\${OVH_DNS_SUBDOMAIN}" // Échappement du $ pour Groovy
                        OVH_DNS_ZONE = "\${OVH_DNS_ZONE}"     // Échappement du $ pour Groovy

                        // URL du dépôt GitLab
                        URL_GITLAB = "https://gitlab.com/iaproject-fr/airquality.git"

                        // Chargement des credentials DockerHub
                        DOCKERHUB_CREDENTIALS = credentials('dockerhub_airquality')
                                ...
                                script {
                                    ...
                                    dir('services/api_ihm') {
                                        ...
                                        sh """
                                            ...
                                            ls -la \${env.PATH_TEST_IHM_SERVICE}/data/datasets/environment_data_analysis.csv || true
